/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../duel-masters-official-crawler/wrangler.jsonc --env-interface=CloudflareEnv` (hash: 77b38128879ab64db8d0f37287ea1b8a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TEAM_DOMAIN" | "POLICY_AUD" | "ADMIN_POLICY_AUD" | "ADMIN_EMAIL">> {}
}

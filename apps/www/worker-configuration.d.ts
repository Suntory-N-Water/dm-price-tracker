/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../duel-masters-official-crawler/wrangler.jsonc --env-interface=CloudflareEnv` (hash: 8ae4e62c28b1cbc32d8a8bbc6e3f0ab2)
...
interface __BaseEnv_CloudflareEnv {
	...
	OFFICIAL_CRAWLER: Service<typeof import("../duel-masters-official-crawler/src/index").default>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_REPOSITORY" | "TEAM_DOMAIN" | "POLICY_AUD" | "ADMIN_POLICY_AUD" | "ADMIN_EMAIL" | "CRAWLER_API_KEY" | "GITHUB_DISPATCH_TOKEN">> {}
}

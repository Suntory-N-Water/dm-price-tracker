/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 839d9336a209f6aea5755f4b4e4e58f5)
// Runtime types generated with workerd@1.20260430.1 2026-07-21 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ORCHESTRATOR: Workflow<Parameters<import("./src/index").MercariCrawlerOrchestrator['run']>[0]['payload']>;
		JOB_WORKFLOW: Workflow<Parameters<import("./src/index").MercariCrawlerJob['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHUNK_SIZE" | "RETRY_LIMIT" | "POLLING_INTERVAL">> {}
}

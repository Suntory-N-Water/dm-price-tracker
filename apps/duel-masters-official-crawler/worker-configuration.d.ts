/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8b1041e663cb88f6fac3299a6c83cbed)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	CARD_IMAGES: R2Bucket;
	duelmasters_card_images: R2Bucket;
	DB: D1Database;
	...
	ORCHESTRATOR: Workflow<Parameters<import("./src/index").DuelMastersOfficialCrawlerOrchestrator['run']>[0]['payload']>;
	JOB_WORKFLOW: Workflow<Parameters<import("./src/index").DuelMastersOfficialCrawlerJob['run']>[0]['payload']>;
}
